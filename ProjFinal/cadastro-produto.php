    ...
    <div class="container">
      ...
      <div class="col-xs-4">
        <form name="cadusuario" method="post" action="" class="form">
          ...
          <div class="form-group col-xs-12">
            <input name="txtvalor" class="form-control" type="text" placeholder="Valor" required="required" pattern="^[0-9,]{2,500}$">
          </div>
          <div class="form-group col-xs-12">
            <input name="txtmarca" class="form-control" type="text" placeholder="Marca" required="required" pattern="^[a-zA-ZÀ-ú ]{2,30}$">
          </div>
          <div class="form-group col-xs-12">
            <input name="txtclasse" class="form-control" type="text" placeholder="Classe" required="required" pattern="^[a-zA-ZÀ-ú ]{2,30}$">
          </div>
          <div class="form-group col-xs-12">
            <input name="txtquantestoque" class="form-control" type="number" placeholder="Quantidade em Estoque" required="required" pattern="^[0-9]{2,500}$">
          </div>
          <div class="form-group col-xs-12">
