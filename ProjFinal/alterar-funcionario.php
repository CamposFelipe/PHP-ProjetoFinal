  ...
  <body>
    ...
    <?php
       ...
       if(isset($_GET['id'])){
         ...
         $array = $pDAO->filtrarFuncionario($query);
         //para testar
         unset($_GET['id']);
       }
       ?>
      ...
      <div class="col-xs-4">
        <form name="alterarfuncionario" method="post" action="">
          <div class="form-group col-xs-12">
            <input name="txtcodigo" class="form-control" type="number" readonly="readonly" required="required" value="<?php if(isset($array))echo $array[0]->idFuncionario?>">
          </div>
          <div class="form-group col-xs-12">
            <input name="txtnome" class="form-control" type="text" required="required" pattern="^[a-zA-ZÀ-ú ]{2,30}$" value="<?php if(isset($array))echo $array[0]->nome?>">
          </div>
          <div class="form-group col-xs-12">
            <input name="txtcargo" class="form-control" type="text" required="required" pattern="^[a-zA-ZÀ-ú ]{2,30}$" value="<?php if(isset($array))echo $array[0]->cargo?>">
          </div>
          <div class="form-group col-xs-12">
            <input name="txtvendas" class="form-control" type="number" required="required" pattern="^[0-9]{2,5000}$" value="<?php if(isset($array))echo $array[0]->vendas?>">
          </div>
          <div class="form-group col-xs-12">
            <input name="txttelefone" class="form-control" type="number" required="required" pattern="^(?\d{2}\)?[\s-]?\d{4}-?\d{4}$" value="<?php if(isset($array))echo $array[0]->telefone?>">
          </div>
          <div class="form-group col-xs-12">
            <input name="txtsalario" class="form-control" type="number" pattern="^[0-9]{2,5000}$" required="required" value="<?php if(isset($array))echo $array[0]->salario?>">
          </div>
       ...
       if(isset($_POST['alterar'])){
         ...
         //padronizacao
         $idFuncionario = $_POST['txtcodigo'];
         $nome = Padronizacao::padronizarMaiMin($_POST['txtnome']);
         $cargo = $_POST['txtcargo'];
         $vendas = Padronizacao::padronizarMaiMin($_POST['txtvendas']);
         $telefone = Padronizacao::padronizarMaiMin($_POST['txttelefone']);
