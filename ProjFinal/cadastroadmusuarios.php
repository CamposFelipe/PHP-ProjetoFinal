  ...
  <body>
    ...
    <div class="container">
      <div class="page-header">
        <h1 class="text-center">Cadastro Cliente/Adm</h1>
      </div>
      <div class="col-xs-4"></div>
      <div class="col-xs-4">
        <form name="cadusuario" method="post" action="" class="form">
          <div class="form-group col-xs-12">
            <input name="txtlogin" class="form-control" type="text" placeholder="Login" required="required" pattern="^[a-zA-ZÀ-ú ]{2,30}$">
          </div>
          <div class="form-group col-xs-12">
            <input name="txtsenha" class="form-control" type="password" placeholder="Senha" required="required" pattern="^[a-zA-ZÀ-ú [0-9]]{8,500}$">
          </div>
          <div class="form-group col-xs-12">
          <select name="seltipo" class="form-control">
            <option value="Usuario">Cliente</option>
            <option value="Adm">Funcionários</option>
          </select>
          </div>
          <div class="form-group col-xs-12">
        ...
        if(isset($_POST['cadastrar'])){
          ...
          $tipo = Padronizacao::padronizarMaiMin($_POST['seltipo']);
