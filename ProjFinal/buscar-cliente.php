      ...
      <div class="table-responsive container">
        ...
        <table class="table table-striped table-bordered table-hover table-condensed">
          ...
          <tbody>
            ...
            foreach($array as $a){
              echo "<tr>";
                echo "<td><a href='alterar-cliente.php?id=$a->idCliente'><img src='img/alterar.png' width=25px; alt='Alterar'/></a></td>";
                echo "<td><a href='buscar-cliente.php?id=$a->idCliente'><img src='img/x.png' width=25px; alt='Excluir'/></a></td>";
