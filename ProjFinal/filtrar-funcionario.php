    ...
    <div>
      ...
      <div class="container">
        <div class="page-header">
          <h1 class="text-center">Filtrar Funcionário</h1>
        </div>
        <form name="filtrarcliente" method="post" action="">
          ...
          <div class="radio-inline">
            <label class="radio-inline"><input type="radio" name="rdfiltro" value="idFuncionario">Código</label>
          </div>
          <div class="radio-inline">
            <label class="radio-inline"><input type="radio" name="rdfiltro" value="nome">Nome</label>
          </div>
          <div class="radio-inline">
            <label class="radio-inline"><input type="radio" name="rdfiltro" value="cargo">Cargo</label>
          </div>
          <div class="radio-inline">
            <label class="radio-inline"><input type="radio" name="rdfiltro" value="vendas">Vendas</label>
          </div>
          <div class="radio-inline">
            <label class="radio-inline"><input type="radio" name="rdfiltro" value="telefone">Telefone</label>
          </div>
          <div class="radio-inline">
            <label class="radio-inline"><input type="radio" name="rdfiltro" value="salario">Salário</label>
          </div>
          <div class="radio-inline">
      ...
      if(isset($_POST['filtrar'])){
        ...
        if($pesq != ""){
          if($filtro == 'idFuncionario'){
            ...
            $query = "where cargo like '%".$pesq."%'";
          }else if($filtro == 'vendas'){
            $query = "where vendas like '%".$pesq."%'";
          }else if($filtro == 'telefone'){
            $query = "where telefone like '%".$pesq."%'";
          }else if($filtro == 'salario'){
            $query = "where salario like '%".$pesq."%'";
          }
        }

      $fDAO = new FuncionarioDAO();
      $array = $fDAO->filtrarFuncionario($query);

      }else{
        $fDAO = new FuncionarioDAO();
        $array = $fDAO->buscarFuncionario();
      }
